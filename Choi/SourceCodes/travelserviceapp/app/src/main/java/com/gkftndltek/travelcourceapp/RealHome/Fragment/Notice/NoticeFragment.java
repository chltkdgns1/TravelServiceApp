package com.gkftndltek.travelcourceapp.RealHome.Fragment.Notice;
...
public class NoticeFragment extends Fragment {
    ...
    private synchronized void init() {
        ...
        databaseReference.child("adminpost").child("관리자").child("notice").addChildEventListener(new ChildEventListener() {
            @Override
