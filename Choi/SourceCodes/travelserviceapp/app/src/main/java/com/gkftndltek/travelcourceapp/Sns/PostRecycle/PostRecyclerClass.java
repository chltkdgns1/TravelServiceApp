...
public class PostRecyclerClass {
    ...
    public void execute(View rootView,Context con, String name,String token){ // 리사이클러뷰 사용 시작
        recyclerView = (RecyclerView) rootView.findViewById(R.id.Post_RecyclerView); // 이거 수정해야함
        ...
        System.out.println("닉네임 다시한번 : " + name);
