...
public class CommentAdaptor extends RecyclerView.Adapter<CommentAdaptor.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView CircleImageView_Comment_Profile;

        public MyViewHolder(View v) {
            super(v);

            CircleImageView_Comment_Profile = v.findViewById(R.id.CircleImageView_Comment_Profile);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        // CircleImageView_Comment_Profile
        holder.CircleImageView_Comment_Profile.setImageResource(pdata.getImageName());
