package com.gkftndltek.travelcourceapp.RealHome.Fragment.Event;
...
public class EventFragment extends Fragment {
    ...
    private synchronized void init(){
        ...
        databaseReference.child("adminpost").child("관리자").child("event").addChildEventListener(new ChildEventListener() {
            @Override
