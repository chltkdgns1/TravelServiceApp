    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(filePath != null) uploadFile();

                Intent intent = new Intent();

                if(filePath != null ) file = filePath.toString();
        ...
        if (filePath != null) {
          ...
          //  progressDialog.setTitle("업로드중...");
           // progressDialog.show();
            ...
            StorageReference storageRef = storage.getReferenceFromUrl("gs://snsproject-defe7.appspot.com").child(Profile);
            //올라가거라...
