        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("이거 네이버에서 가져온 데이터 맞아요? : " + data);
                    ...
                    if (!data.isEmpty()) { // 제이슨 형태로 받아서 해결해줍니다.
                        ...
                        for (int i = 0; i < k && i < 10; i++) {
                            ...
                            if(title != null ) naverData.setLink(getImageBitmap(getLocationImage(title))); // getLocationImage(title)
