package com.gkftndltek.travelcourceapp.RecyclerView;
...
public class DestinationAdapter extends RecyclerView.Adapter<DestinationAdapter.MyViewHolder>{
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            //TextView_CourceAdd = v.findViewById(R.id.TextView_CourceAdd);
    ...
    public DestinationAdapter(View.OnTouchListener touch) { // 찾아온 목록 클릭했을 때의 이벤트 처리 생성자 상태
        data = new ArrayList<>();
        touchListener = touch;
    }
