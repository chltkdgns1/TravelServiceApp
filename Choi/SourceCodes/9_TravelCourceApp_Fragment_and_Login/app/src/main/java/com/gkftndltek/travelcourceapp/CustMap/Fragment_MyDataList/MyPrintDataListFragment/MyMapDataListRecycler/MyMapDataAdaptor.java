package com.gkftndltek.travelcourceapp.CustMap.Fragment_MyDataList.MyPrintDataListFragment.MyMapDataListRecycler;
...
public class MyMapDataAdaptor extends RecyclerView.Adapter<MyMapDataAdaptor.MyViewHolder>{
    ...
    @Override
    public MyMapDataAdaptor.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        ...
        MyMapDataAdaptor.MyViewHolder vh = new MyMapDataAdaptor.MyViewHolder(v);
        return vh;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(MyMapDataAdaptor.MyViewHolder holder, int position) {
