package com.gkftndltek.travelcourceapp.Fragment_Home;
...
import com.gkftndltek.travelcourceapp.Fragment_PersonalMap.NoneBitmapDestData;
import com.gkftndltek.travelcourceapp.MainActivity;
import com.gkftndltek.travelcourceapp.R;
import com.gkftndltek.travelcourceapp.RecyclerView.DestinationDataClass;
import com.gkftndltek.travelcourceapp.RecyclerView.DestinationsClass;
                ...
                alert_ex.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(noneBitmapDestData != null) {
                            ...
                            users.child(token).child("xy").child(noneBitmapDestData.getName()).setValue(noneBitmapDestData );
