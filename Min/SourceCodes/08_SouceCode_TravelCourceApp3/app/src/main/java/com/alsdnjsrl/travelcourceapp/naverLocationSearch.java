...
public class naverLocationSearch {
    final String clientId = "cJmAC7snZ3GUZPeHLChn";//애플리케이션 클라이언트 아이디값";
    final String clientSecret = "uMaq6tZUWc";//애플리케이션 클라이언트 시크릿값";
            ...
            public void run() {
                try {
                    ...
                    if (!data.isEmpty()) { // 제이슨 형태로 받아서 해결해줍니다.
                        ...
                        for (int i = 0, k = objArr.length(); i < k && i < 10; i++) {
