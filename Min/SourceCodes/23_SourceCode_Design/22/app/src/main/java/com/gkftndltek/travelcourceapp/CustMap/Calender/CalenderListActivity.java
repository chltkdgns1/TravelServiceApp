...
public class CalenderListActivity  extends AppCompatActivity {
    ...
    private Button Button_CalenderView_Add;
    ...
    void init(){
        ...
        Button_CalenderView_Add = findViewById(R.id.Button_CalenderView_Add);

        Button_CalenderView_Add.setOnClickListener(new View.OnClickListener() {
            @Override
