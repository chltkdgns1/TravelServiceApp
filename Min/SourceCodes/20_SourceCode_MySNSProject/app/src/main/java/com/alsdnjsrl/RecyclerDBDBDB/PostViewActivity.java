...
public class PostViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent1.getExtras()!=null) {
            ...
            String Contents = intent1.getExtras().getString("Contents");
            String Username = intent1.getExtras().getString("Username");
            String Profile = intent1.getExtras().getString("Profile");
