...
public class MainActivity extends AppCompatActivity {
    private String key = "l7xxbd658eb97e754d96b8ad89150fc67fed";
...
//                            marker.setCalloutTitle("나 클릭했엉?");
                          ...
                          //  markerx = dstData.getX();
                         //   markery = dstData.getY();
                           // tMapView.setCenterPoint(markery ,markerx, true); // 이 새키 반대인거 꼭 기억하죠 ㅜㅜ
                ...
                tMapView.setCenterPoint(destData.getY(),destData.getX());
                // 뭘까요?? ㅋ 뭐긴 시발 반대지 ㅋ
            }
        }
    };
 ...
 */
        ...
        destinationsClass.execute(this, getApplicationContext(),handlerPushMessage );
