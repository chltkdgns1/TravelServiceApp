...
public class MainActivity extends AppCompatActivity {
    ...
    void init() {
        ...
        storageRef = storage.getReferenceFromUrl("gs://travelcourseapp-9bbda.appspot.com");
        ...
        imm.hideSoftInputFromWindow( EditText_Post_Search.getWindowToken(),0);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1) {
            ...
            synchronized (this) {
                ...
                String path = "post/"+ user+"/" + primaryKey;
                ...
                databaseReference.child(user).child(primaryKey).setValue(pdata);
                ...
                if (uriStrContainer != null) {
                    ...
                    for (int i = 0; i < uriStrContainer.size(); i++) {
                        ...
                        databaseReference.child(user).child(primaryKey).child("pictures").child(temp).setValue(1);
                    }
                }
